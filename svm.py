...
X, y = datasets[0]
ax = plt.subplot(2, len(datasets), i)
run_classifier(X, y, ax, krnl='linear', C_val=1, mrg=1)   #choose krnl from {'linear', 'poly', 'rbf'}, set the value of C_val and gamma (for 'rbf').
i += 1
...
X, y = datasets[2]
ax = plt.subplot(2, len(datasets), i)
run_classifier(X, y, ax, krnl='rbf', C_val=1, mrg=1, gamma=1)   #choose krnl from {'linear', 'poly', 'rbf'}, set the value of C_val and gamma (for 'rbf').
i += 1

# Classifier for the data in the last column
X, y = datasets[3]
ax = plt.subplot(2, len(datasets), i)
run_classifier(X, y, ax, krnl='poly', C_val=1, mrg=1)   #choose krnl from {'linear', 'poly', 'rbf'}, set the value of C_val and gamma (for 'rbf').
